            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {highlights.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-[#ffd33d]/10 border border-yellow-500/20 flex items-center justify-center">
                      <Icon className="w-7 h-7 text-[#ffd33d]" />
                    </div>
